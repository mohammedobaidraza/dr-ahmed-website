  ...
  return (
    ...
    >
      ...
      <div className="lg:hidden relative flex flex-col min-h-[100svh]">
        {/* Doctor photo */}
        <div className="relative w-full" style={{ height: "60vw", minHeight: 260, maxHeight: 420 }}>
          <Image
            src="/assets/dr-ahmed-profile.jpg"
      ...
      <div className="hidden lg:flex relative min-h-[100svh] max-w-[1400px] mx-auto px-10 w-full">
        ...
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="flex flex-col justify-center lg:pt-40 xl:pt-48 pb-12 w-[54%] shrink-0 pr-8"
        >
        ...
        >
          <div className="relative h-full w-full flex items-end">
            <div
              ...
              style={{
                background:
                  "linear-gradient(to bottom, transparent 0%, transparent 50%, rgba(6,27,51,1) 100%), linear-gradient(to left, transparent 60%, rgba(6,27,51,0.7) 100%), linear-gradient(to right, rgba(6,27,51,0.3) 0%, transparent 30%)",
              }}
            />
            <div className="relative w-full" style={{ height: "90vh", maxHeight: 860 }}>
              <Image
                src="/assets/dr-ahmed-profile.jpg"
          ...
          <motion.div
            ...
            className="absolute bottom-32 left-0 z-20 rounded-xl"
            style={{
      ...
      >
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10">
          <div className="grid grid-cols-2 lg:grid-cols-4">
            {[
              { label: "Board-Certified", sub: "American Board of Orthopaedic Surgery" },
              { label: "Fellowship-Trained", sub: "Adult Reconstruction, Cleveland Clinic" },
              { label: "Robotic-Assisted", sub: "Robot-assisted knee & hip replacement" },
              { label: "Subspecialized", sub: "Practice focused on hip & knee replacement" },
            ].map((item, i) => (
              <div
                key={item.label}
                className="px-5 py-5"
                style={{
                  ...
                  borderTop: i >= 2 ? "1px solid rgba(200,162,90,0.1)" : "none",
                }}
              >
                <p className="text-[#C8A25A] text-[9.5px] font-bold tracking-[0.22em] uppercase mb-1">
                  {item.label}
                </p>
                <p className="text-white/50 text-[12px] leading-snug">{item.sub}</p>
              </div>
            ))}
          </div>
        </div>
